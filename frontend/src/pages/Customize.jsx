  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#030353] flex justify-center items-center flex-col'>
     ...
     <div className='w-[90%] max-w-[60%] flex justify-center items-center flex-wrap gap-[15px]'>
         ...
         <Card image={image6}/>
         <Card image={image7}/>
      <div className={` w-[70px] h-[160px] lg:w-[140px] lg:h-[250px] bg-[#030326] border-2 border-[#0000ff66] rounded-2xl overflow-hidden
   ...
   <input type='file' accept='image/*' ref={inputImage} onChange={handleImage} />
     ...
     {selectedImage &&   <button  className='min-w-[150px] h-[50px] mt-4 text-center text-black cursor-pointer font-semibold bg-blue-700 rounded-full text-[20px]'
